...
public class ShareCookie_Admin_SideBarMenu extends BaseTest {
    ...
    public void TC01_VerifySidebarMenu(){
        Assert.assertTrue(sideAndTopBar.isMenuDisplayed("Admin"));
        Assert.assertTrue(sideAndTopBar.isMenuDisplayed("PIM"));
        Assert.assertTrue(sideAndTopBar.isMenuDisplayed("Leave"));
        Assert.assertTrue(sideAndTopBar.isMenuDisplayed("Time"));
        Assert.assertTrue(sideAndTopBar.isMenuDisplayed("Recruitment"));
        ...
        Assert.assertTrue(sideAndTopBar.isMenuDisplayed("Maintenance"));
